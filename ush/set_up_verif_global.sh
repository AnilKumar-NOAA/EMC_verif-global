...
if [ $machine = "WCOSS2" ]; then
    ...
    export STMP="/gpfs/f5/${ACCOUNT}/scratch/${USER}"
    export PTMP="/gpfs/f5/${ACCOUNT}/scratch/${USER}"
    export NOSCRUB="/gpfs/f5/${ACCOUNT}/scratch/${USER}"
    export global_archive="/gpfs/f5/${ACCOUNT}/world-shared/global/metplus.data/archive"
    export prepbufr_arch_dir="/gpfs/f5/${ACCOUNT}/world-shared/global/metplus.data/prepbufr"
    export obdata_dir="/gpfs/f5/${ACCOUNT}/world-shared/global/metplus.data/obdata"
    export ccpa_24hr_arch_dir="/gpfs/f5/${ACCOUNT}/world-shared/global/metplus.data/obdata/ccpa_accum24hr"
    ...
    export STMP="/gpfs/f6/${ACCOUNT}/scratch/${USER}"
    export PTMP="/gpfs/f6/${ACCOUNT}/scratch/${USER}"
    export NOSCRUB="/gpfs/f6/${ACCOUNT}/scratch/${USER}"
    export global_archive="/gpfs/f6/${ACCOUNT}/world-shared/global/metplus.data/archive"
    export prepbufr_arch_dir="/gpfs/f6/${ACCOUNT}/world-shared/global/metplus.data/prepbufr"
    export obdata_dir="/gpfs/f6/${ACCOUNT}/world-shared/global/metplus.data/obdata"
    export ccpa_24hr_arch_dir="/gpfs/f6/${ACCOUNT}/world-shared/global/metplus.data/obdata/ccpa_accum24hr"
    export METviewer_AWS_scripts_dir="/gpfs/f6/${ACCOUNT}/world-shared/global/metplus.data/VRFY/METviewer_AWS"
